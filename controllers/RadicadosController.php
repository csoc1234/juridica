...
class RadicadosController extends Controller
{
  ...
  public function actionCreateMPDF(){
    ...
    public function actionDevolucion($id){
      ...
      if ($devolucion->id_entidad !="") {
          $devolucion->save(false);
          $radicado->estado = 3;
          $radicado->save(false);
          $this->redirect(Yii::$app->request->baseUrl."?r=entidades%2Fview&id=".$radicado->id_entidad);
      } else { //Entidad no existe en Perjur
          $this->redirect(Yii::$app->request->baseUrl."?r=resoluciones%2Fdevolucionentidad&id=".$radicado->id_radicado);
      }
