...
class ResolucionesController extends Controller
{
    ...
    public function actionDevolucion($id){
      ...
      break;
       ...
       $mes=ResolucionesController::mes($mes);
       //list($año,$mes,$dia) = explode("-",$radicado->fecha_creacion);
        ...
        if ($var_libros && ($tipoEntidad['id_tipo_entidad'] == 9 || $tipoEntidad['id_tipo_entidad'] == 12)){
          // PLANTILLA JAC
          $document = new TemplateProcessor ('plantillas/Plantilla Devolucion1.docx');
        } else {
          // PLANTILLA OTRAS ENTIDADES
        ...
        $document->setValue("direccion_entidad",$entidad['direccion_entidad']);
        $document->setValue("telefono_entidad",$entidad['telefono_entidad']);
        $document->setValue("email_entidad",$entidad['email_entidad']);
              ...
              case 2:
                ...
                if($var_temp2 == 1 || $var_temp2 == 3 || $var_temp2 == 7 || ($var_temp2 == 9 && in_array(1,explode(",",$radicado['id_tipo_resolucion_combinada'])))){
                  ...
                  for ($i=0; $i <sizeof($dignatarios) ; $i++) {
                    ...
                    if($aux < 0 ){
                      $dignatarios_1 .= GruposCargos::findOne($dignatarios[$i]['id_grupo_cargos'])['nombre_grupo_cargo']."<w:br w:type='line'/>" 
                      .Cargos::findOne($dignatarios[$i]['id_cargo'])['nombre_cargo']."<w:br w:type='line'/>";
                      $dignatarios_2 .= "<w:br w:type='line'/>"."<w:br w:type='line'/>";
                      //$dignatarios_2 .= $dignatarios[$i]['nombre_dignatario'] ." C.C: ".$dignatarios[$i]['cedula_dignatario']."<w:br w:type='line'/>"; 
                      $dignatarios_2 .= $dignatarios[$i]['nombre_dignatario'] . "<w:br w:type='line'/>";
                      $dignatarios_3 .= "<w:br w:type='line'/>"."<w:br w:type='line'/>";
                      $dignatarios_3 .= $dignatarios[$i]['cedula_dignatario'] . "<w:br w:type='line'/>";
                    }else{
                      if(GruposCargos::findOne($dignatarios[$i]['id_grupo_cargos'])['nombre_grupo_cargo'] == GruposCargos::findOne($dignatarios[$aux]['id_grupo_cargos'])['nombre_grupo_cargo']){
                        $dignatarios_1 .= Cargos::findOne($dignatarios[$i]['id_cargo'])['nombre_cargo']."<w:br w:type='line'/>";
                        //$dignatarios_2 .= $dignatarios[$i]['nombre_dignatario'] ." C.C: ".$dignatarios[$i]['cedula_dignatario']."<w:br w:type='line'/>";
                        $dignatarios_2 .= "<w:br w:type='line'/>";
                        $dignatarios_2 .= $dignatarios[$i]['nombre_dignatario'] . "<w:br w:type='line'/>";
                        $dignatarios_3 .= "<w:br w:type='line'/>";
                        $dignatarios_3 .= $dignatarios[$i]['cedula_dignatario'] . "<w:br w:type='line'/>"; 
                      }else{
                        $dignatarios_1 .= "<w:br w:type='line'/>";
                        $dignatarios_1 .= GruposCargos::findOne($dignatarios[$i]['id_grupo_cargos'])['nombre_grupo_cargo']."<w:br w:type='line'/>" 
                ...
                if(!empty($dignatarios)){
                  for ($i=0; $i <sizeof($dignatarios) ; $i++) {
                      ...
                      if($aux < 0 ){
                        ...
                        $dignatarios_1_grid = Cargos::findOne($dignatarios[$i]['id_cargo'])['nombre_cargo'];
                        $dignatarios_2_grid = $dignatarios[$i]['nombre_dignatario'];
                        $dignatarios_3_grid = $dignatarios[$i]['cedula_dignatario'];

                        // Cabecera
                        $var_grid .= "<w:p>" . "<w:pPr><w:jc w:val='center'/>". "<w:pStyle w:val='Heading1'/>" . "<w:r><w:rPr><w:b/></w:rPr><w:t>" . strtoupper(GruposCargos::findOne($dignatarios[$i]['id_grupo_cargos'])['nombre_grupo_cargo']) . "</w:t></w:r>" . "</w:pPr>" . "</w:p>";

                        $var_grid .= "<w:tbl>" . "<w:tblPr>" . "<w:tblStyle w:val='TableGrid'/>" . "<w:tblW w:w='5000' w:type='pct'/>" . "</w:tblPr>" ."<w:tblGrid>" . "<w:gridCol w:w='2880'/>" ."<w:gridCol w:w='2880'/>" . "<w:gridCol w:w='2880'/>" . "</w:tblGrid>";

                        $var_grid .= "<w:tr>" . "<w:tc>" . "<w:tcPr>". "<w:tcW w:w='5880' w:type='dxa'/>" . "</w:tcPr>" . "<w:p>" . "<w:r><w:rPr><w:b/></w:rPr>" . "<w:t>NOMBRES Y APELLIDOS</w:t>" . "</w:r>" . "</w:p>" . "</w:tc>";

                        $var_grid .= "<w:tc>" . "<w:tcPr>" . "<w:tcW w:w='4880' w:type='dxa'/>" . "</w:tcPr>" . "<w:p>" . "<w:r><w:rPr><w:b/></w:rPr>" . "<w:t>CARGO</w:t>" . "</w:r>" . "</w:p>" . "</w:tc>";

                        $var_grid .= "<w:tc>" . "<w:tcPr>" . "<w:tcW w:w='3880' w:type='dxa'/>" . "</w:tcPr>" . "<w:p>" . "<w:r><w:rPr><w:b/></w:rPr>" . "<w:t>DOCUMENTO DE IDENTIDAD</w:t>" . "</w:r>" . "</w:p>" . "</w:tc>" . "</w:tr>";

                        // Info
                        $var_grid .= "<w:tr>";

                        $var_grid .= "<w:tc>" . "<w:tcPr>" . "<w:tcW w:w='5880' w:type='dxa'/>" . "</w:tcPr>" . "<w:p>" . "<w:r>" . "<w:t>" . $dignatarios_2_grid . "</w:t>" . "</w:r>" . "</w:p>" . "</w:tc>";

                        $var_grid .= "<w:tc>" . "<w:tcPr>" . "<w:tcW w:w='4880' w:type='dxa'/>" . "</w:tcPr>" . "<w:p>" . "<w:r>" . "<w:t>" . $dignatarios_1_grid . "</w:t>" . "</w:r>" . "</w:p>" . "</w:tc>";

                        $var_grid .= "<w:tc>" . "<w:tcPr>" . "<w:tcW w:w='4880' w:type='dxa'/>" . "</w:tcPr>" . "<w:p>" . "<w:r>" . "<w:t>" . $dignatarios_3_grid . "</w:t>" . "</w:r>" . "</w:p>" . "</w:tc>";
                ...
                $var_calidad_cargo = "".$cargo_representante." ejercerá como Representante Legal ";
                ...
                $var_gaceta = "Publíquese en la Gaceta Departamental a costa de los interesados, de conformidad con el Decreto 1529 de 1990, compilado por el Decreto No. 1066 de 2015, numeral 2.2.1.3.10.";
                ...
                $var_paragrafo_legal = "";
                $var_articulo_reposicion = "Contra el presente acto administrativo procede el recurso de reposición, el cual podrá ser interpuesto por escrito dentro de los diez (10) días hábiles siguientes su notificación.";
                $var_articulo_conformidad = "Notifíquese la presente Resolución de conformidad con lo dispuesto por el artículo 67 y s.s. del Código de Procedimiento Administrativo y de lo Contencioso Administrativo.";
                $var_articulo_rige = "La presente resolución rige a partir de su ejecutoria.";
                ...
                $var_articulo_cpaca = "";
                $var_articulo_representante = "De conformidad con el artículo No __ de los estatutos, el ".$var_calidad_cargo. " de la entidad.";
                $var_articulo_periodo = "De conformidad con los Artículos No _______ de los estatutos de la entidad denominada ".$nombre_entidad. ", ".$var_disciplina. ", el periodo por el cual se eligen los anteriores dignatarios es de ____ años. Por tanto, su vigencia va hasta el día ___ de ___ de ___.";
                ...
                $var_articulo_dignatarios = "Inscríbase a las siguientes personas como dignatarios de la entidad denominada ".$nombre_entidad. ", con domicilio en el Municipio de " .$municipio_entidad['municipio'] .", departamento del Valle del Cauca. Según consta en el Acta de Asamblea General ordinaria Nº ____ del ___ de ________ de ____, y en la Resolución No ____ del ____ de ____ de ____";
                ...
                if($tipoEntidad['id_tipo_entidad'] == 10 || $tipoEntidad['id_tipo_entidad'] == 6){
                  ...
                  $var_leyes .= "en ejercicio de la delegación emanada del  decreto Departamental No.1638 de 2020 y  de las atribuciones legales conferidas por los artículos 211 de la Constitución Política de Colombia y 9° de la Ley 489 de 1998, ";
                  $var_leyes .= "Decreto 525 de 1990 (compilado por el Decreto 1075 de 2015), ley 181 de 1995, Decreto ley 1228 de 1995, resolución 231 de 2011 ";
                  //$var_leyes .= "Decreto 525 de 1990 (compilado por el Decreto 1075 de 2015), ley 181 de 1995, Decreto ley 1228 de 1995, ley 1946 del 4 enero de 2019, ley 1967 del 11 de julio del 2019 (compilados por el Decreto Único Reglamentario 1085 de 2015).";
                ...
                elseif($tipoEntidad['id_tipo_entidad'] == 9 || $tipoEntidad['id_tipo_entidad'] == 12 || $tipoEntidad['id_tipo_entidad'] == 14 || $tipoEntidad['id_tipo_entidad'] == 48){
                  ...
                  $var_leyes .= " y de las atribuciones legales conferidas por los artículos 211 de la Constitución Política de Colombia y 9° de la Ley 489 de 1998,";
                  $var_leyes .= "Ley 743 de 2002, Decreto Reglamentario 2350 de 2003, Decreto Reglamentario 890 de 2008, Circular EXT. CIR09-156-DDP-0210";
                  //$var_leyes .= "Ley 743 de 2002, Decreto Reglamentario 2350 de 2003, Decreto Reglamentario 890 de 2008, Circular EXT. CIR09-156-DDP-0210";
                ...
                // SE VERIFICA SI ES UNA ENTIDAD DE SALUD
                elseif($tipoEntidad['id_tipo_entidad'] == 8){
                  $var_leyes .= "de conformidad con el decreto No 1-3-1638 del 23 de Octubre de 2020 y en ejercicio de las atribuciones legales conferidas por los artículos 211 de la constitución política y con fundamento en las siguientes normas: ";
                  $var_leyes .= "Ley 10 de 1990, Decreto 1088 de 1991, resolución 13565 del 1991 (compilados por el decreto único reglamentario 780 del 2016)";
                  //$var_leyes .= "Decreto 1088 de 1981, ley 10 de 1990, resolución 13565 del 1991 (compilados por el decreto único reglamentario 780 del 2016)";
                ...
                elseif($tipoEntidad['id_tipo_entidad'] == 5){
                  $var_leyes .= "de conformidad con el decreto No 1-3-1638 del 23 de Octubre de 2020 y en ejercicio de las atribuciones legales conferidas por los artículos 211 de la constitución política y con fundamento en las siguientes normas: ";
                  $var_leyes .= "Decreto 525 de 1990 (compilado por el Decreto 1075 de 2015), ley 115 de 1994 (compilado por el decreto 1075 de 2015), Ley 1064 de 2006, Decreto 4904 de 2009";
                  //$var_leyes .= "Decreto 525 de 1990 (compilado por el Decreto 1075 de 2015), ley 115 de 1994 (compilado por el decreto 1075 de 2015)";
                ...
                switch($radicado['id_tipo_resolucion'])
                {
                  case 1: // RECONOCIMIENTO DE PERSONERIA
                    ...
                    $var_articulo_reforma .= "Aprobar los estatutos de la entidad denominada ".$nombre_entidad. ", con domicilio en el municipio de " .$municipio_entidad['municipio'] ." departamento del Valle del Cauca, que fueron presentados y corresponden a los adoptados por acta de Asamblea General No. ____  del ____ de ____ de _________";
                  ...
                  case 9: // COMBINADO: INSCRIPCION - REFORMA - REGISTRO DE LIBROS
                    ...
                    if($var_inscripcionDignatarios)
                    {
                      ...
                      //$var_leyes_dignatarios .= $tipoEntidad['id_tipo_entidad'];

                      // ENTIDAD DEPORTIVA O LIGA
                      if($tipoEntidad['id_tipo_entidad'] == 10 || $tipoEntidad['id_tipo_entidad'] == 6 || $tipoEntidad['id_tipo_entidad'] == 1){ 
                        $var_leyes_dignatarios .= "en ejercicio de la delegación emanada del  decreto Departamental No.1638 de 2020 y  de las atribuciones legales conferidas por los artículos 211 de la Constitución Política de Colombia y 9° de la Ley 489 de 1998, Decreto 525 de 1990 (compilado por el Decreto 1075 de 2015), ley 181 de 1995, Decreto ley 1228 de 1995, resolución 231 de 2011,  Articulo 4, 5, 16 del";
                      }
                      // ORGANO COMUNAL
                      elseif($tipoEntidad['id_tipo_entidad'] == 9 || $tipoEntidad['id_tipo_entidad'] == 12 || $tipoEntidad['id_tipo_entidad'] == 14 || $tipoEntidad['id_tipo_entidad'] == 48){
                        $var_leyes_dignatarios .= "y de las atribuciones legales conferidas por los artículos 211 de la Constitución Política de Colombia y 9° de la Ley 489 de 1998, Ley 743 de 2002, Decreto Reglamentario 2350 de 2003, Decreto Reglamentario 890 de 2008, Circular EXT. CIR09-156-DDP-0210, Articulo 16 del";
                      }
                      // ENTIDAD DE SALUD
                      elseif($tipoEntidad['id_tipo_entidad'] == 8){
                        $var_leyes_dignatarios .= "de conformidad con el Decreto No 1-3-1638 del 23 de Octubre de 2020 y de las atribuciones legales conferidas por los artículos 211 de la Constitución Política de Colombia y 9° de la Ley 489 de 1998, ley 10 de 1990, Decreto 1088 de 1981, Resolución 13565 del 1991 (compilados por el decreto único reglamentario 780 del 2016), Articulo 5 del";
                      }
                      // ENTIDAD EDUCATIVA
                      elseif($tipoEntidad['id_tipo_entidad'] == 5){
                        $var_leyes_dignatarios .= "de conformidad con el decreto No 1-3-1638 del 23 de Octubre de 2020, y con fundamento en las siguientes normas: Decreto 525 de 1990 (compilado por el Decreto 1075 de 2015), ley 115 de 1994 (compilado por el decreto 1075 de 2015), Ley 1064 de 2006, Decreto 4904 de 2009 y";
                      }
                      $var_leyes_dignatarios .= " Decreto 1529 de 1990 (compilado por el decreto único reglamentario 1066 de 2015)";
                    ...
                    if($var_registroLibros)
                    {
                      ...
                      if(!empty($TiposLibros)){
                        foreach($TiposLibros as $valor){
                          ...
                          $var_libros_registrados .= $NombreLibro .";";
                        }
                ...
                $document->setValue("var_leyes_dignatarios",$var_leyes_dignatarios);
                ...
                $document->setValue("var_articulo_representante",$var_articulo_representante);
                $document->setValue("var_articulo_periodo",$var_articulo_periodo);
                $document->setValue("var_articulo_reposicion",$var_articulo_reposicion);
                $document->setValue("var_articulo_conformidad",$var_articulo_conformidad);
                $document->setValue("var_articulo_rige",$var_articulo_rige);  
                ...
                $document->setValue("var_libros_registrados",$var_libros_registrados);                


                $document->setValue("tipo_regimen",$tipo_regimen);
                $document->setValue("dignatarios_1",$dignatarios_1);
                $document->setValue("dignatarios_2",$dignatarios_2);
                $document->setValue("dignatarios_3",$dignatarios_3);

                $document->setValue("var_grid",$var_grid);
