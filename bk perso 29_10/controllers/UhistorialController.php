...
/**
 * UhistorialController implements the CRUD actions for Uhistorial model.
 */
...
$only = ['uhistorial', 'index','create', 'update', 'view','samplepdf','sampleexcel'];
return [
      'access' => [
          ...
          'rules' => [
              [
                  'actions' => ['historial', 'index', 'create','update', 'view','samplepdf','sampleexcel'],
                  'allow' => true,
                  'roles' => ['@'],
