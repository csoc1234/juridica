...
class RadicadosController extends Controller
{
     ...
     */
     ...
     $only = [ 'index','create', 'update','view','reporte','samplepdf','tramitar','finalizado','rechazado','Vencido','devolucion'];
     return [
         'access' => [
             ...
             'rules' => [
                 [
                     'actions' => ['index','create', 'update','view','reporte','samplepdf','tramitar','finalizado','rechazado','Vencido','devolucion'],
                     'allow' => true,
                     'roles' => ['@'],
