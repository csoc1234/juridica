...
class ResolucionesController extends Controller
{
   ...
   //End sitios
    ...
    public function actionDevolucion($id){
      ...
      $presidente = Dignatarios::find()->where(['and', ['id_entidad'=>$entidad['id_entidad']],['id_cargo' => 1],['estado' => 1] ])->all(); 

        if($presidente != null)
        {
          $municipio_presidente  = Municipios::findOne($presidente[0]['id_municipio_expedicion']);
      ...
      if($tipoEntidad['id_tipo_entidad'] == 1 || $tipoEntidad['id_tipo_entidad'] == 6){
      ...
      break;
       ...
       list($año,$mes,$dia) = explode("-",$radicado->fecha_creacion);
        ...
        $document->setValue("presidente",$presidente[0]['nombre_dignatario']);
        ...
        $document->saveAs('Devolucion '.$entidad['nombre_entidad'].'.docx');
        header('Content-Disposition: attachment; filename=Devolucion '.$entidad['nombre_entidad'].'.docx; charset=iso-8859-1');
        echo file_get_contents('Devolucion '.$entidad['nombre_entidad'].'.docx');
    ...
    {  
        ...
        if($flag_entidad_comunitaria || $radicado->fecha_gaceta != null){
        ...
        $presidente = Dignatarios::find()->where(['and', ['id_entidad'=>$entidad['id_entidad']],['id_cargo' => 1],['estado' => 1] ])->all(); 
          ...
          if(empty($presidente) && $representante_legal_ivc == null){
            ...
            switch($tipoRadicado)
            {
              ...
              case 1:
                ...
                if($var_temp1 == 1 || $var_temp1 == 4 ){
                  ...
                  for ($i=0; $i <sizeof($dignatarios) ; $i++) {
                    ...
                    ."C.C: ".$dignatarios[$i]['cedula_dignatario']." Exp: ".Municipios::findOne($dignatarios[$i]['id_municipio_expedicion'])['municipio']."<w:br w:type='line'/>"           
                    ."PERIODO ".$dignatarios[$i]['inicio_periodo']." A ".$dignatarios[$i]['fin_periodo']
                ...
                switch($radicado['id_tipo_certificado'])
                {
                  ...
                  case 2: // Certificado de Existencia y Representacion Legal
                    ...
                    $var_dignatario .= "Que el(la) actual Representante legal de la citada entidad, en su condición de presidente es el(la) señor(a) " .$presidente[0]['nombre_dignatario']." identificado(a) con la Cédula de Ciudadanía ".$presidente[0]['cedula_dignatario']." expedida en ".$municipio_presidente['municipio']."-".$departamento_presidente['departamento'].", cuyo nombre se encuentra inscrito en los registros que para tal efecto se llevan en este despacho.";
                    $var_articulo_estatutos = "";
                    $var_articulo_registro_libros = "";
                  ...
                  case 5: // Certificado IVC
                    ...
                    $representante_legal_ivc=$presidente[0]['nombre_dignatario'];
                    $cedula_ivc=$presidente[0]['cedula_dignatario'];
                ...
                if($entidad != null){
                  $document->saveAs('Certificado '.$entidad['nombre_entidad'].'.docx');
                  header('Content-Disposition: attachment; filename=Certificado '.$entidad['nombre_entidad'].'.docx; charset=iso-8859-1');
                  echo file_get_contents('Certificado '.$entidad['nombre_entidad'].'.docx');
                }else{
              ...
              case 2:
                ...
                $var_calidad_cargo = "Presidente y Representante Legal ";
                ...
                elseif($tipoEntidad['id_tipo_entidad'] == 9 || $tipoEntidad['id_tipo_entidad'] == 12 || $tipoEntidad['id_tipo_entidad'] == 14 || $tipoEntidad['id_tipo_entidad'] == 48){
                  ...
                  $var_leyes .= "Ley 743 de 2002, Decreto Reglamentario 2350 de 2003, Decreto Reglamentario 890 de 2008, Circular EXT. CIR09-156-DDP-0210";
                  $var_leyes_1 .= "El peticionario acompañó a la solicitud los documentos exigidos en la Ley 743 de junio 5 de 2002, Decreto Reglamentario 2350 de agosto 20 de 2003, y Decreto Reglamentario 890 de 28 de marzo de 2008 (compilados por el Decreto Único reglamentario 1066 de 2015)."
                  ."<w:br w:type='line'/>" ."<w:br w:type='line'/>"   
                  ."Revisados los documentos se encontró que la elección y la solicitud están de acuerdo con los requisitos legales consagrados en la Ley 743 de junio 5 de 2002, Decreto Reglamentario 2350 de agosto 20 de 2003, y Decreto Reglamentario 890 de 28 de marzo de 2008 (compilados por el Decreto Único reglamentario 1066 de 2015)."
                  ."<w:br w:type='line'/>" ."<w:br w:type='line'/>";
                  $var_paragrafo_legal = "";
                ...
                switch($radicado['id_tipo_resolucion'])
                {
                  ...
                  case 3: // ASIMILAR PERSONERIA
                    ...
                    $entidad_asimilacion = Entidades::findOne($asimilacion['valor_anterior_campo']);
                ...
                $document->setValue("nombre_presidente",$presidente[0]['nombre_dignatario']);
                $document->setValue("cedula_presidente",$presidente[0]['cedula_dignatario']);
                $document->setValue("municipio_presidente",$municipio_presidente['municipio']);
                $document->setValue("departamento_presidente",$departamento_presidente['departamento']);
                ...
                $document->saveAs('Resolucion '.$entidad['nombre_entidad'].'.docx');
                header('Content-Disposition: attachment; filename=Resolucion '.$entidad['nombre_entidad'].'.docx; charset=iso-8859-1');
                echo file_get_contents('Resolucion '.$entidad['nombre_entidad'].'.docx');
