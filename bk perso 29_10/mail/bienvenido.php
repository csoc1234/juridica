  ...
  <div><div class="adM">
      	...
      	<table width="600" border="0" cellpadding="0" cellspacing="0">
  	  		<tbody>
  	  			<tr>
  					<td ></td>
  					<td >
  						<p style="font-family:arial,helvetica,verdana;font-weight:normal;font-size:32px;line-height:1.2;color:#00a8df;display:block;text-align:left;margin:0;padding:0;text-align:center">BIENVENIDO/A</p>
  					</td>
  					</tr>
  			</tbody>
  		</table>
    ...
    <tr>
      <table width="600" border="0" cellpadding="0" cellspacing="10" align="center">
        	  		<tbody>
        	  			<tr>
        					<td><span style="font-family:arial,helvetica,verdana;font-weight:normal;font-size:14px;line-height:1.2;color:#50525a;display:block;margin:0;padding:0;text-align:justify">Su registro en la plataforma de personerias de la Gobernación del Valle se ha realizado de manera exitosa.</spam></td>
        				</tr>
        			</tbody>
      </table>
    </tr>
      	...
      	<table width="600" border="0" cellpadding="0" cellspacing="0" align="center">
  	  		<tbody>
                  ...
                  <tr bgcolor="#f1f4f6" style="font-family:arial,helvetica,verdana;font-weight:bold;font-size:14px;line-height:1.2;color:#50525a;margin:0">
                    <td width="185">Cedula/Nit</td>
                    <td width="185"><?php echo $cedula; ?></td>

                  </tr>
  					  			<tr bgcolor="#f1f4f6" style="font-family:arial,helvetica,verdana;font-weight:bold;font-size:14px;line-height:1.2;color:#50525a;margin:0">
  					  				<td width="185">Nombres</td>
  					  				<td width="185"><?php echo $nombres; ?></td>
                    ...
                    <tr bgcolor="#f1f4f6" style="font-family:arial,helvetica,verdana;font-weight:bold;font-size:14px;line-height:1.2;color:#50525a;margin:0">
  					  			...
  					  			<tr bgcolor="#f1f4f6" style="font-family:arial,helvetica,verdana;font-weight:normal;font-size:14px;line-height:1.2;color:#50525a;margin:0">
  					  				<td>
  										Recuerda ingresar al portal de personerias con tu N° de cédula y contraseña <span style="color:#1988EA"></span> .</td>
  					  				<td width="190">
  									<table>
  									 <tbody><tr>
    ...
    <tr>
    	<td>
    		<br>
    		<p style="font-family:arial,helvetica,verdana;font-weight:bold;font-size:17px;line-height:1.2;color:#50525a;display:block;text-align:center;margin:0;padding:0">¡Gracias por registrase!</p><br>
