  ...
  <div><div class="adM">
    ...
    <tbody><tr align="center">
      <td style="vertical-align:top" colspan="3">
  	  ...
  	  <center> <img src="img/escudocolombiano.png" width="25%"></center>
      	...
      	<table width="600" border="0" cellpadding="0" cellspacing="0">
  	  		<tbody>
  	  			<tr>
  					<td ></td>
  					<td >
  						<p style="font-family:arial,helvetica,verdana;font-weight:normal;font-size:32px;line-height:1.2;color:#00a8df;display:block;text-align:left;margin:0;padding:0;text-align:center">Asignación de radicado</p>
  					</td>
  					</tr>
  			</tbody>
  		</table>
    ...
    <tr>
      <table width="600" border="0" cellpadding="0" cellspacing="10" align="center">
        	  		<tbody>
        	  			<tr>
        					<td><span style="font-family:arial,helvetica,verdana;font-weight:normal;font-size:14px;line-height:1.2;color:#50525a;display:block;margin:0;padding:0;text-align:justify">Se le ha asignado el radicado No. <?php echo $nradicado;?>. </spam></td>
        				</tr>
        			</tbody>
      </table>
    </tr>
