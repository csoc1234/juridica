...
class Entidades extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['personeria_year', 'personeria_n', 'nombre_entidad', 'direccion_entidad', 'telefono_entidad', 'email_entidad', 'id_tipo_entidad', 'id_clase_entidad', 'municipio_entidad', 'estado_entidad','periodo_entidad', 'id_tipoRegimen','fecha_estatutos'], 'required'],
            [['personeria_year', 'personeria_n', 'municipio_entidad', 'id_tipo_entidad', 'id_clase_entidad', 'estado_entidad','periodo_entidad', 'id_tipoRegimen'], 'integer'],
            [['fecha_reconocimiento', 'fecha_gaceta','fecha_estatutos'], 'safe'],
            ['email_entidad','email'],
            [['file'], 'file', 'skipOnEmpty' => true, 'extensions' => 'doc,pdf,docx', 'maxSize'=> '10485760'], //10485760 = 10 * 1024 * 1024
            [['datos_digitales'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'personeria_n' => 'Número Personeria',
