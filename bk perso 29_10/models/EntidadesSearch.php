...
class EntidadesSearch extends Entidades
{
    ...
    public function rules()
    {
        return [
            ...
            [['nombre_entidad', 'fecha_reconocimiento', 'direccion_entidad', 'telefono_entidad', 'email_entidad', 'ubicacion_archivos_entidad', 'fecha_gaceta', 'datos_digitales','rango_fecha','fecha_hasta','fecha_desde','fecha_estatutos'], 'safe'],
        ];
    }
