            ...
            <div class="box box-primary">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            ...
                            echo Html::tag('span', '<h3> <span class="fa fa-info-circle" tool-tip-toggle="tooltip-demo"</span></h3>', [
                                    'title'=>'Formato fechas: día-mes-año
                                    2019-12-31',
                                    'data-toggle'=>'tooltip',
                ...
                <div class="rows">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-10">
                            <?php        
                                echo $form->field($model, 'observaciones')->textarea(['rows' => 5]);
                            ?>
                        </div>
                ...
                <div class="rows">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-10">
                            <?php                            
                              echo $form->field($model, 'ubicacion_archivos_entidad')->textInput(['maxlength' => true, 'id' => 'ubicacion','disabled' => true]);
                            ?>
                        </div>
