...
class RadicadosSearch extends Radicados
{
    ...
    {
        return [
            [['id_radicado', 'id_tipo_tramite', 'estado', 'id_entidad', 'id_usuario_tramita', 'id_usuario_creacion', 'sade','id_dignatario_tramite'], 'integer'],
            [['descripcion', 'n_radicado_interno' , 'ubicacion', 'fecha_creacion','id_tipo_resolucion','id_tipo_certificado','rango_fecha','fecha_hasta','fecha_desde'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'id_dignatario_tramite' => $this->id_dignatario_tramite,
        ...
        $query->andFilterWhere(['like', 'descripcion', $this->descripcion])
            ...
            ->andFilterWhere(['>=', 'fecha_creacion', $this->fecha_desde])
            ->andFilterWhere(['<=', 'fecha_creacion', $this->fecha_hasta]);
