...
class Radicados extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_tipo_tramite', 'estado', 'id_usuario_creacion', 'id_motivo', 'fecha_creacion'], 'required'],
            [['descripcion','descripcion_cancelado','n_radicado_interno','id_tipo_resolucion','id_tipo_certificado', 'id_tipo_resolucion_combinada','id_tipo_reforma_estatutaria','id_tipo_registro_libro','cantidad_libros'], 'string'],
     ...
     */
     public function attributeLabels()
     {
         return [
             ...
             'id_tipo_tramite' => 'Tipo de acto administrativo',
             'estado' => 'Estado',
             'id_entidad' => 'Entidad',
             ...
             'n_radicado_interno' => 'Número radicado interno (Opcional)',
             'id_tipo_resolucion'  => 'Tipo de tramite Resolucion',
             'id_tipo_certificado'  => 'Tipo de tramite Certificado',
             ...
             'fecha_gaceta' => 'Fecha gaceta (Opcional)',
             'descripcion_cancelado' => 'Motivo de la cancelación del radicado'
	...
	public function getTipoResolucion(){
          $resolucion = TipoResolucion::findOne($this->id_tipo_resolucion);
        return $resolucion['nombre_tipo_resolucion'];
        }
	public function getTipoCertificado(){
          $certificado = TipoCertificado::findOne($this->id_tipo_certificado);
        return $certificado['nombre_tipo_certificado'];
        }
