...
/**
 * CertificarSearch represents the model behind the search form of `app\models\Validacion`.
 */
class CertificarSearch extends Validacion
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['fecha_creacion', 'fecha_sistem', 'codigo_h', 'codigo_cons'], 'safe'],
        ];
    }
